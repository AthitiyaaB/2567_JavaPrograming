public class TestCustomer {
	...
	public static void main(String[] args) {
		...
		Line();
		// show customer's id
		System.out.println("customer id is: " + c1.getCusID());
		// show customer's name
		System.out.println("customer name is: " + c1.getCusName());
		// show customer's discount
		System.out.println("customer discount is: " + c1.getDiscount());
		Line();
		...
		System.out.println("customer's id is: " + inv1.getCustomerDiscount());
		// show invoice's amount after discount(format as output)
		System.out.println("customer's discount is: " + inv1.getAmountAfterDiscount());
	} // end of main method()
